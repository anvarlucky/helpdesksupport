...
class AnnouncementController extends BaseControllerForClient
{
    public function index(){
        $announcements = $this->get('http://support.mc.uz/api/admin/announcements');
    ...
    public function store(Request $request){
        ...
        $announcement = $this->put('http://support.mc.uz/api/admin/announcements',$request,true,'image');
    ...
    public function show($id){
        $announcement = $this->get('http://support.mc.uz/api/admin/announcements/'.$id);
    ...
    public function update(Request $request,$id){
        $request = $request->except('_token');
        $announcement = $this->put('http://support.mc.uz/api/admin/announcements/'.$id,$request,true,'image');
    ...
    public function destroy($id){
        $announcement = $this->delete('http://support.mc.uz/api/admin/announcements/'.$id);
        if($announcement->success){
            return redirect()->route('announcement.index');
        }
    }
