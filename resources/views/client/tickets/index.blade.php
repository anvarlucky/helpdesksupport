...
<div class="card">
    <div class="card-header">
        <strong class="card-title">Custom Table</strong> | <a href="{{route('ticks.create')}}">Yangi ticket qo'shish</a>
    </div>
        ...
        <table class="table ">
            ...
            @foreach($tickets as $key => $ticket)
                <tr>
                    ...
                    <td> #{{$ticket->id}} </td>
                    <td><a href="{{route('ticks.show',$ticket->id)}}"><span class="name">{{$ticket->title}}</span></a></td>
